...
productMoudle.controller('productListCtrl', ['$scope', '$http', '$location', '$stateParams', 'Const', 'fyData', function($scope, $http, $location, $stateParams, Const, fyData) {
    ...
    function init() {
        ...
        fyData.getToken(function(token) {
            getProductContent(token, $stateParams.categoryId, function(res) {
                // res = JSON.parse(res);
            ...
            getCategoryInfo(token, $stateParams.categoryId, function(res) {
    ...
    function getProductContent(token, CategoryID, fun) {
        $http({
            method: 'GET',
    ...
    function getCategoryInfo(token, CategoryID, fun) {
        $http({
            method: 'GET',
...
productMoudle.controller('productDetailCtrl', ['$scope', '$http', '$location', '$stateParams', 'Const', 'fyData', function($scope, $http, $location, $stateParams, Const, fyData) {
    ...
    function init() {
        ...
        fyData.getToken(function(token) {
            getCategoryInfo(token, $stateParams.parentCategoryId, function(res) {
                // res = JSON.parse(res);
                $scope.productCategory = res;
            });

            getProductDetail(token, $stateParams.categoryId, function(res) {
                // res = JSON.parse(res);
                $scope.dataGetSuccess = true;
    ...
    function getProductDetail(token, productId, fun) {
